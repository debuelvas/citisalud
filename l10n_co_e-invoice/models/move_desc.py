...
class KsGlobalTaxInvoice(models.Model):
    ...
    invoice_discount_view = fields.Monetary(related="invoice_discount",string='Desc. De Factura')
    invoice_discount_percent = fields.Float(string='Desc. De Factura %', readonly=False,)
    invoice_discount_tax = fields.Selection(selection=[('00', 'Descuento Base Impuesto'),
                                                        ('01', 'Descuento Sin Base Impuesto')],string='Motivo de Descuento')
    sales_discount_account = fields.Many2one('account.account',string="Sales Tax Account")
    purchase_discount_account = fields.Many2one('account.account', string="Purchase Tax Account")
...
class AccountMoveLine(models.Model):
    ...
    price_unit_with_discount = fields.Float()
